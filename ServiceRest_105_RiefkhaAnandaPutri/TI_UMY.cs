...
namespace ServiceRest_105_RiefkhaAnandaPutri
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-C3KCD2B;Initial Catalog=TI_UMY;Persist Security Info=True;User ID=sa;Password=chika.00");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-C3KCD2B;Initial Catalog=\"TI_UMY\";Persist Security Info=True;User ID=sa;Password=chika.00");
